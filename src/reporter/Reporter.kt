...
object Reporter {
     ...
     * Initialized on [Reporter.initialize] - should not be changed afterwards.
     */
    lateinit private var map: MutableMap<Class<out Event>, MutableSet<SubscriberEventHandler>>
